...
const AuthForm = ({ isSignup, onSuccess }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const authData = { email, password, name, address }; // Include address in authData

    const apiEndpoint = isSignup ? `${process.env.REACT_APP_API_BASE_URL}/customers/register` : `${process.env.REACT_APP_API_BASE_URL}/customers/login`;
